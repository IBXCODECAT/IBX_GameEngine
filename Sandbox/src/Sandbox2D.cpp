...
{
	IBX_PROFILE_FUNCTION("Sandbox2D::OnUpdate");

	{
		// Update
		IBX_PROFILE_SCOPE("CameraController::OnUpdate");
		m_CameraController.OnUpdate(ts);
	}

	{
		// Render
		IBX_PROFILE_SCOPE("Renderer Prep");
	...
	{
		IBX_PROFILE_SCOPE("Renderer Draw");
...
{
	IBX_PROFILE_FUNCTION("Sandbox2D::OnImGuiRender");
